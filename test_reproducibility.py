...
for f in ["data/shap/SHAP_BiLSTM_PSO_values.pkl", "data/analysis_dataset.csv",
          "code/figure17_shap_beeswarm.py", "code/figure18_teleconnection.py",
          "code/susceptibility_class_area.py"]:
    (ok if os.path.exists(f) else warn)(f"repro asset {f}")
