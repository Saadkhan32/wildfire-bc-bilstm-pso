#!/usr/bin/env python3
"""
Fig. 17 - SHAP beeswarm for the PSO-optimized BiLSTM.
Generates the interpretability figure from the stored SHAP values
(data/shap/SHAP_BiLSTM_PSO_values.pkl). The atmospheric-moisture feature is
ERA5-Land specific humidity (kg/kg).

Run from repo root (wildfire env):  python code/figure17_shap_beeswarm.py
Output: figs/Fig17_SHAP.png  and  .pdf
Requires: numpy, matplotlib, shap
"""
import os, pickle
import numpy as np
import matplotlib
...
def main():
    ...
    names = list(d["feature_names"])  # already labelled Specific Humidity
