"""ArcGIS preprocessing (requires ArcGIS Pro / arcpy + the GIS source layers in Table 1).
Set the workspace via the WILDFIRE_GIS environment variable; not required for the
Python analyses, which use the shipped data/ tables and rasters."""
import os
import arcpy
import pandas as pd
arcpy.env.overwriteOutput = True
arcpy.CheckOutExtension("Spatial")
PROJECT_FOLDER = os.environ.get("WILDFIRE_GIS", ".")  # ArcGIS workspace holding 01_GIS/ source layers (set WILDFIRE_GIS env var)
OUT_GDB = os.path.join(PROJECT_FOLDER, "01_GIS", "seed_sensitivity.gdb")
BC_BOUNDARY = rf"{PROJECT_FOLDER}\01_GIS\bc_boundary.shp"
WILDFIRE_POINTS = rf"{PROJECT_FOLDER}\01_GIS\wildfire_points_1992.shp"
...
PREDICTOR_RASTERS = [
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\Aspect.tif",              "Aspect",              "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\Slope.tif",               "Slope",               "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\Elevation.tif",           "Elevation",           "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\TWI.tif",                 "TWI",                 "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\ProfileCurv.tif",         "Profile_Curvature",   "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\PlanCurv.tif",            "Plan_Curvature",      "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\NDVI.tif",                "NDVI",                "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\LULC.tif",                "LULC",                "categorical"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\MaxTemp.tif",             "Max_Temperature",     "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\Precipitation.tif",       "Precipitation",       "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\WindSpeed.tif",           "WS",                  "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\SpecificHumidity.tif",    "Specific_Humidity",   "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\AET.tif",                 "AET",                 "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\DSI.tif",                 "DSI",                 "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\SoilMoisture.tif",        "Soil_Moisture",       "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\DistanceRoads.tif",       "Distance_roads",      "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\DistanceRivers.tif",      "Distance_rivers",     "continuous"],
    [rf"{PROJECT_FOLDER}\01_GIS\rasters\DistanceHouseholds.tif",  "Distance_households", "continuous"],
]
