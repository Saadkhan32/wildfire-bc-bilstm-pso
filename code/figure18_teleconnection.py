"""
Fig. 18 - ENSO/PDO teleconnection controls on BC wildfire (2000-2024).
...
Self-contained: no repo-internal imports.

Input (paths from repo root):
  data/analysis_dataset.csv   annual 2000-2024 with columns:
  ...
  data/climate/BC_ERA5Land_monthly_specific_humidity_2000_2024.csv (fire-season mean).

Output: figs/Fig18_ENSO_teleconnection.{pdf,tif,png}

Run from repo root:  python code/figure18_teleconnection.py
...
# climate variables: SH = specific humidity
