...
BiLSTM PSO FE.py
================
BiLSTM + Conv1D wildfire-susceptibility classifier with Particle-Swarm
hyperparameter optimization and leakage-safe RFE feature selection,
evaluated under 10-fold spatial GroupKFold (50 km blocks).
