...
LSTM PSO FE.py
==============
Unidirectional LSTM + Conv1D wildfire-susceptibility classifier with
Particle-Swarm hyperparameter optimization and leakage-safe RFE feature
selection, evaluated under 10-fold spatial GroupKFold (50 km blocks).
...
def build_lstm_cnn(n_features: int,
    ...
    """
    CNN stem → 1–2 stacked LSTM (unidirectional) → Dropout → Dense → Sigmoid
    """
...
def main():
    ...
    # final holdout metrics (on the 15% validation split)
